...
public class QuickChatMessage  {
    ...
    public static void main(String[] args) {
        ...
        // 0. Capture first name and last name for welcome message
...
class Message {
    ...
    String checkRecipientCell() {
        if (recipient.length() <= 11 && recipient.startsWith("+")) {
    ...
    void createMessageHash() {
        ...
        int msgNum = QuickChatMessage.sentMessages.size();
    ...
    String sentMessage(int option) {
        switch (option) {
            case 1 -> {
                QuickChatMessage.sentMessages.add(this);
    ...
    public int returnTotalMessagess() {
        return QuickChatMessage.sentMessages.size();
    }
}